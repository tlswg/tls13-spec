...
EKR: This cite is not correct. The link is fine but Elgamal is not an
author on this specification.
-->
...
EKR: No, this is not correct. close_notify must be sent and user_canceled should be ignored.
-->
...
EKR: Actually a definition list without a following colon seems to work.
Updated.
-->
...
EKR: I believe the current text is fine.
-->
