...
- TLS Cipher Suites registry: Values with the first byte in the range
  ...
  The "DTLS-OK" and "Recommended" columns are both marked as "Y" for
  these cipher suites.
...
The TLS ExtensionType Values, TLS Cipher Suites, TLS Supported Groups, TLS
Exporter Labels, TLS HashAlgorithm, TLS Certificate Types,
TLSPskKeyExchangeMode, and TLS SignatureScheme registries have a
"Recommended" column.  See {{Section 3 of ?RFC9847}} for additional information
