...
normative:
  ...
  PRE-RFC9846:
       ...
       seriesinfo:
         RFC: PRE-9846
       target: https://www.rfc-editor.org/info/PRE-RFC9846
...
- Remove ambiguity around which hash is used with PreSharedKeys and
  HelloRetryRequest.
...
- Correct the lower bound on CertificateRequest.extensions
  to be 0 bytes. This was an error in the syntax as it
  is possible to send no extensions, which results in
  length 0.

- Correct the lower bound on ClientHello.extensions. This
  was a calculation error.

- Correct the upper bound on NewSessionTicket.extensions.
  This was a calculation error.

- Use more generic language for the asymmetric key exchange,
  which was previously exclusively (EC)DHE,
  to reflect the use of KEM-based key exchange.

- Clarify the interaction of the transcript hash with
...
| status_request {{RFC6066}} {{PRE-RFC9846}}     |  CH, CR, CT |
| supported_groups {{RFC7919}} {{PRE-RFC9846}}   |      CH, EE |
| signature_algorithms {{PRE-RFC9846}}           |      CH, CR |
...
| pre_shared_key {{PRE-RFC9846}}       |      CH, SH |
| early_data {{PRE-RFC9846}}           | CH, EE, NST |
| supported_versions {{PRE-RFC9846}}   | CH, SH, HRR |
| cookie {{PRE-RFC9846}}               |     CH, HRR |
| psk_key_exchange_modes {{PRE-RFC9846}}|          CH |
| certificate_authorities {{PRE-RFC9846}}|      CH, CR |
| oid_filters {{PRE-RFC9846}}          |          CR |
| post_handshake_auth {{PRE-RFC9846}}  |          CH |
| signature_algorithms_cert {{PRE-RFC9846}}|      CH, CR |
| key_share {{PRE-RFC9846}}            | CH, SH, HRR |
...
- Network attackers who take advantage of client retry behavior to
  ...
  processed as 0-RTT data on connection 1 and as 1-RTT data on
  connection 2.
...
IANA has added references to this document for the status_request and
...
using Encrypted Client Hello {{RFC9849}}.
...
clients and/or servers across connections. Use of
Encrypted Client Hello {{RFC9849}} can
