...
cipher_suites
: This is a vector of the symmetric cipher options supported by the
  ...
  order of client preference. If the vector contains cipher suites that
...
client_shares
: A vector of offered KeyShareEntry values in descending order of client preference.
{:br }
...
KeyShareEntry values for groups not in the client's
...
certificate_list
: This is a vector (chain) of CertificateEntry structures, each
