...
One of the content types supported by the TLS Record Protocol is the alert type.
...
detected, the detecting party sends an alert message to the other party. Upon
