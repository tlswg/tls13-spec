...
information MUST be provisioned to both parties:
  ...
  * The Application-Layer Protocol Negotiation (ALPN) labels supported, if any
...
The parameters for the 0-RTT data (symmetric cipher suite, etc.) are the same
as those which were negotiated in the connection
