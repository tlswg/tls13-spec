...
before it receives the client's Finished.
...
PSK ciphersuites can either use PSK in combination with
...
random_bytes
: 32 bytes generated by a secure random number generator. See {{implementaiton-notes}} for additional information.
{:br }
